            ...
            <nav class="col-md-2 d-none d-md-block bg-dark sidebar">
              <div class="sidebar-sticky">
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item px-0 mt-2 mb-1 text-muted">
                    <a class="nav-link" href="#">
                      <span data-feather="file"></span>
                      <p style="color:#ffffff"><img src="{{ asset('iconos/Wallet_64.png') }}" width="30" height="30">Estado de Cuenta</p>
                    </a>
                  </li>
                  <li class="nav-item px-0 mt-2 mb-1 text-muted">
                    <a class="nav-link" href="#">
                      <span data-feather="shopping-cart"></span>
                      <p style="color:#ffffff"><img src="{{ asset('iconos/PaymentHistory_96px.png') }}" width="30" height="30">Historial de Pagos</p>
                    </a>
                  </li>
